<template>
    <div>
      ...
      <div class="min-h-screen bg-gradient-to-b from-white to-gray-100 py-10 px-4 sm:px-6 md:px-8">
        <div class="max-w-lg mx-auto" ref="successContainer">
          <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div class="bg-[#800040] py-8 px-6 flex flex-col items-center relative">
              ...
              <div class="relative z-10 mb-2" ref="iconContainer">
                <div class="w-20 h-15 bg-white rounded-full flex items-center justify-center shadow-lg">
            ...
            <div class="px-6 py-8" ref="contentContainer">
              <div class="flex flex-col items-center mb-6">
                <div class="w-16 h-16 bg-[#D4AF37] bg-opacity-20 rounded-full flex items-center justify-center mb-3">
              ...
              <div class="space-y-3 sm:space-y-0 sm:flex sm:space-x-3" ref="buttonsContainer">
                <NuxtLink to="/perfil" class="w-full block text-center py-3 px-4 bg-[#800040] text-white font-semibold rounded-lg hover:bg-opacity-90 transition-all shadow sm:flex-1">
                  <Icon name="mdi:ticket" class="mr-1" /> Veure les meves entrades
                </NuxtLink>
                <NuxtLink to="/" class="w-full block text-center py-3 px-4 bg-gray-200 text-gray-700 font-semibold rounded-lg hover:bg-gray-300 transition-all sm:flex-1">
                  <Icon name="mdi:home" class="mr-1" /> Tornar a l'inici
                </NuxtLink>
              </div>
            </div>
          ...
          <!-- Banner promocional -->
          <div class="mt-8 bg-gray-100 border border-gray-200 rounded-lg p-4 flex items-center" ref="promoContainer">
            <div class="mr-4 hidden sm:block">
              <Icon name="mdi:movie" class="text-[#800040] text-4xl" />
            </div>
            <div>
              <h3 class="font-semibold text-[#800040]">Cinema Pedralbes et recomana</h3>
              <p class="text-sm text-gray-600 mt-1">No et perdis les nostres properes estrenes. Consulta la nostra cartellera!</p>
              <NuxtLink to="/pelicules/cartelera" class="inline-block mt-2 text-[#D4AF37] hover:underline text-sm font-medium">
                Veure cartellera <Icon name="mdi:arrow-right" class="inline text-xs" />
              </NuxtLink>
            </div>
          </div>
        </div>
  ...
  // Generar el código de reserva solo en el cliente
  onMounted(() => {

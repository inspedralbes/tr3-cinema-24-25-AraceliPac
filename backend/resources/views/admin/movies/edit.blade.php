...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-md-12">
            <h2>Editar Pel·lícula: {{ $movie->title }}</h2>
        </div>
    </div>
            ...
            <div class="dashboard-card">
                <form action="{{ route('admin.movies.update', $movie->id) }}" method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="release_year">Any d'estrena</label>
                                <input type="number" class="form-control @error('release_year') is-invalid @enderror" id="release_year" name="release_year" value="{{ old('release_year', $movie->release_year) }}" min="1900" max="{{ date('Y') + 1 }}">
                                @error('release_year')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('duration') is-invalid @enderror" id="duration" name="duration" value="{{ old('duration', $movie->duration) }}" min="1">
                                @error('duration')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="3">{{ old('description', $movie->description) }}</textarea>
                                @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="genre_id">Gènere</label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('director_id') is-invalid @enderror" id="director_id" name="director_id" required>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('image') is-invalid @enderror" id="image" name="image" value="{{ old('image', $movie->image) }}">
                                @error('image')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="trailer">URL del tràiler</label>
                                <input type="text" class="form-control @error('trailer') is-invalid @enderror" id="trailer" name="trailer" value="{{ old('trailer', $movie->trailer) }}">
                                @error('trailer')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('actor_ids') is-invalid @enderror" id="actor_ids" name="actor_ids[]" multiple>
                                ...
                                <small class="form-text text-muted">Manté premuda la tecla Ctrl (o Command en Mac) per seleccionar múltiples actors.</small>
                                @error('actor_ids')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <button type="submit" class="btn" style="background-color: #800040; color: #FFFFFF;">
                                Guardar Canvis
                            </button>
                            <a href="{{ route('admin.movies.index') }}" class="btn btn-secondary">Cancel·lar</a>
                        </div>
                    </div>
                </form>
            </div>
